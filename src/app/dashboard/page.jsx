        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          {myMatches.length === 0 ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center">
              ...
              <h3 className="text-gray-900 font-bold mb-1">Belum ada jadwal tanding</h3>
              <p className="text-gray-500 text-sm mb-4">Buat jadwal sekarang untuk mencari lawan sparring.</p>
            ...
            <div className="grid gap-4">
              {myMatches.map((m) => (
                <div key={m.id} className={`group relative border p-5 rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 transition hover:shadow-md ${m.status === 'Closed' ? 'bg-gray-50 border-gray-200' : 'bg-white border-gray-200'}`}>
                  
                  {/* Info Kiri: Tanggal & Lokasi */}
                  <div className={m.status === 'Closed' ? 'opacity-60' : ''}>
                  ...
                  <div className="flex items-center gap-3 w-full md:w-auto">
                    {m.status === 'Open' && (
                      <button 
                        ...
                        className="flex-1 md:flex-none bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-lg text-sm font-bold transition shadow-sm hover:shadow flex items-center justify-center gap-2"
                    ...
                    <button 
                      ...
                      className="flex-1 md:flex-none border border-red-200 text-red-600 hover:bg-red-50 px-4 py-2.5 rounded-lg text-sm font-bold transition flex items-center justify-center gap-2"
                    ...
                    >
                      ...
                      {m.status === 'Open' ? 'Hapus' : 'Hapus Riwayat'}
                    </button>
                  </div>
